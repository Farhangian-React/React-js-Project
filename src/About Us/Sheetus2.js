...
export default function Sheetus2() {
  return (
    ...
    <Box className='boxmain'>
       <Grid container spacing={2} sx={{mt:2,height:'50%',display:'flex',bgcolor:'white'}}>
        <Grid  xs={12} md={6} sx={{pb:3,pt:2,px:15,mt:0, display:'flex' ,flexDirection:'column',justifyContent:'center',bgcolor:'#464541'}}>
           <QrCodeOutlinedIcon sx={{mt:1,mb:0,fontSize:{sx:'55px',md:'65px'},alignSelf:'center',color:'white'}}/>
...
همه‌ی تلاشمون رو می‌کنیم.</Typography>
        ...
        <HandshakeOutlinedIcon sx={{mt:1,mb:0,fontSize:{sx:'55px',md:'65px'},alignSelf:'center',color:'white'}}/>
    ...
    <Grid container spacing={2} sx={{mt:0,heights:'50%',display:'flex',bgcolor:'white'}}>
        <Grid  xs={12} md={6} sx={{pb:3,px:15,mt:0, display:'flex' ,flexDirection:'column',justifyContent:'center',bgcolor:'#464541'}}>
           <ModelTrainingOutlinedIcon sx={{mt:1,mb:0,fontSize:{sx:'55px',md:'65px'},alignSelf:'center',color:'white'}}/>
        ...
        <AdsClickOutlinedIcon sx={{mt:1,mb:0,fontSize:{sx:'55px',md:'65px'},alignSelf:'center',color:'white'}}/>
    ...
    <Typography  sx={{fontSize:{xs:'14px',md:'24px'},mt:0.5,textAlign:'center',color:'white'}}> ارزش های ما   </Typography>
    </Box>
    </Box>
