...
<NavLink to={'/bushbrands'}><img src="https://cdn.icon-icons.com/icons2/2845/PNG/512/bosch_logo_icon_181287.png" alt='' /></NavLink>
    ...
    <div ref={bagbox1}
className='flex flex-col lg:flex-row bg-white p-5 m-5'
   > 
       <div ref={tinybox1} className='flex justify-center flex-col my-5 w-[100%] lg:w-[50%]'>
...
className='flex flex-col lg:flex-row bg-white p-5 m-5'
   > 
       <div ref={tinybox2} className='flex justify-center flex-col my-5 w-[100%] lg:w-[50%]'>
...
className='flex flex-col lg:flex-row bg-white p-5 m-5'
   > 
       <div ref={tinybox3} className='flex justify-center flex-col my-5 w-[100%] lg:w-[50%]'>
...
className='flex flex-col lg:flex-row bg-white p-5 m-5'
   > 
       <div ref={tinybox4} className='flex justify-center flex-col my-5 w-[100%] lg:w-[50%]'>
