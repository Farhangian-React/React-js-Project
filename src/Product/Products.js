...
<NavLink to={'/whirlpoolbrand'}><img src="https://i.pinimg.com/736x/58/6c/08/586c08b09fff9fc53d34d15844a80e1c.jpg" alt='' /></NavLink>
    ...
    <Box ref={bagbox1} sx={{my:2 ,mx:5,px:5,py:1,bgcolor:"white",borderRadius:'10px',display:"flex",flexDirection:{xs:"column",lg:"row"}}}> 
       <Box ref={tinybox1} sx={{display:"flex",justifyContent:"start",flexDirection:"column",my:{xs:2,lg:10},width:{xs:"90%",lg:"50%"}}}>
       <Box ref={refbox1} sx={{mx:{xs:2,lg:5},height:"290px",overflow:"hidden"}} >
...
در کشور ما کارخانه‌های تولید یخچال و فریزر وجود دارند که کالاهای با کیفیتی می‌سازند و به نسبت مدل خارجی‌شان به صرفه ترند. مشهورترین برندهای ایرانی شامل یخچال و فریزر اسنوا، امرسان، پارس، الکترواستیل، هیمالیا اند. معروف‌ترین برندهای خارجی یخچال که در ایران هم نمایندگی دارند، شامل: جنرال آمریکایی، ال جی، سامسونگ، هاینس و... اند. گران‌ترین  برند، یخچال و فریزر سامسونگ است که قیمت این برند معمولا بیشتر از سایر یخچال‌ها و فریزرها است. 
      ...
      خرید آنلاین انواع یخچال و فریزر از سهیل 
         ...
         <Button ref={refbutton1} onClick={addstyle1}  sx={{':hover':{bgcolor:"white",color:"#E0AA3E"},fontSize:{xs:"14px",lg:"16px"},color:'#E0AA3E',
    ...
    <Box ref={bagbox2} sx={{mx:5,my:2 ,mx:5,px:5,py:1,bgcolor:'white',borderRadius:'10px',display:"flex",flexDirection:{xs:"column",lg:"row"}}}> 
    <Box ref={tinybox2}  sx={{display:"flex",justifyContent:"start",flexDirection:"column",my:{xs:2,lg:10},width:{xs:"90%",lg:"50%"},direction:"rtl"}}>
       <Box  ref={refbox2} sx={{mx:{xs:2,lg:5},height:"290px",overflow:"hidden"}} >
       <Typography variant="h5" sx={{py:1,textAlign:"justify"}}  >
       ماشین لباسشویی
         </Typography>
         <Typography  paragraph sx={{color:"#828282",textAlign:"justify"}}>
...
تمام لوازم خانگی برقی برچسب میزان مصرف انرژی دارند. لوازم برقی که میزان مصرف انرژی آن‌ها زیر A قرار گرفته است، ماهانه هزینه زیادی برای پرداخت قبض برق روی دست شما می‌گذارد. برای جلوگیری از این موضوع شما می‌توانید با بررسی جدول ماشین‌های لباسشویی در دیجی‌کالا میزان مصرف انرژی آن‌ها را بررسی و با هم مقایسه کنید.
        ...
        <Button ref={refbutton2} onClick={addstyle2}  sx={{':hover':{bgcolor:"white",color:"#E0AA3E"},fontSize:{xs:"14px",lg:"16px"},color:'#E0AA3E',
       bgcolor:"white",alignSelf:"start",my:3,mx:{xs:2,lg:5}}}>   ادامه ی مطلب... </Button>
    ...
    <Box ref={bagbox3} sx={{mx:5,my:2 ,mx:5,px:5,py:1,bgcolor:'white',borderRadius:'10px',display:"flex",flexDirection:{xs:"column",lg:"row"}}}> 
    <Box ref={tinybox3}  sx={{display:"flex",justifyContent:"start",flexDirection:"column",my:{xs:2,lg:10},width:{xs:"90%",lg:"50%"}}}>
       <Box ref={refbox3} sx={{mx:{xs:2,lg:5},height:"290px",overflow:"hidden"}}>
         <Typography variant="h5" sx={{py:1,textAlign:"justify"}}  >
         اجاق گاز
         </Typography>
          <Typography  paragraph sx={{color:"#828282",textAlign:"justify"}}>
...
اما اگر بودجه بیشتری برای خرید اجاق گاز دارید، اجاق فردار برقی می ‌تواند جلوه‌ خاصی به آشپزخانه شما بدهد. همچنین می ‌توانید نگاهی به اجاق‌ گازهای 6 شعله استیل بیاندازید. قیمت اجاق گاز برقی و گازی بزرگ در مارک ‌های ایرانی تفاوت زیادی با هم ندارند. اجاق‌ گازهای استیل ظاهر بسیار جذابی دارند و وجودشان دکوراسیون آشپزخانه های مدرن را تکمیل می ‌کند. فر ‌در سبک آشپزی امروزی نقش پر رنگی دارد و آشپزی را برای خیلی از افراد راحت‌ کرده‌ است.
        ...
        <Button ref={refbutton3} onClick={addstyle3}  sx={{':hover':{bgcolor:"white",color:"#E0AA3E"},fontSize:{xs:"14px",lg:"16px"},color:'#E0AA3E',
       bgcolor:"white",alignSelf:"start",my:3,mx:{xs:2,lg:5}}}>   ادامه ی مطلب... </Button>
                  <Box  xs={12}  sx={{display:{xs:'flex',sm:'flex'},justifyContent:"start"}}>
       <Button variant='contained'  sx={{':hover':{backgroundImage:"linear-gradient(to right ,#eeeeee,#282828)",
       color:'white'},fontSize:{xs:"22px",md:"18px"},color:'#eeeeee',m:3,
    ...
    <Box ref={bagbox4} sx={{mx:5,my:2 ,mx:5,px:5,py:1,bgcolor:'white',borderRadius:'10px',display:"flex",flexDirection:{xs:"column",lg:"row"}}}> 
    <Box ref={tinybox4}  sx={{display:"flex",justifyContent:"start",flexDirection:"column",my:{xs:2,lg:10},width:{xs:"90%",lg:"50%"},direction:"rtl"}}>
       <Box ref={refbox4} sx={{mx:{xs:2,lg:5},height:"290px",overflow:"hidden"}}>
       <Typography variant="h5" sx={{py:1,textAlign:"justify"}}  >
...
توکار: طراحی بسیاری از آشپزخانه‌ها به طوری است که کالاهایی چون ماشین ظرفشویی، فر و ماکروفر در داخل کابیت‌ها قرار می‌گیرند و دیگر نیازی نیست آن‌ها را روی کابینت قرار دهید.
    ...
    <Button ref={refbutton4} onClick={addstyle4}  sx={{':hover':{bgcolor:"white",color:"#E0AA3E"},fontSize:{xs:"14px",lg:"16px"},color:'#E0AA3E',
       bgcolor:"white",alignSelf:"start",my:3,mx:{xs:2,lg:5}}}>   ادامه ی مطلب... </Button>
                    <Box  xs={12}  sx={{display:{xs:'flex',sm:'flex'},justifyContent:'start'}}>
         <Button variant='contained'  sx={{':hover':{backgroundImage:"linear-gradient(to right ,#eeeeee,#282828)",
         color:'white'},fontSize:{xs:"22px",md:"18px"},color:'#eeeeee',m:3,
