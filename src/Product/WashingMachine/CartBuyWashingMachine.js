...
const [index, setIndex] = React.useState(null);
  ...
  <Box container sx={{display:'flex',flexDirection:{xs:'column',lg:'row'},bgcolor:'white',mx:5,mt:3,mb:5,borderRadius:'10px',direction:'rtl'}}>
...
<Modal   open={!!layout} onClose={() => setLayout(undefined)}>
        ...
        {cartItems.map(i=><Typography variant='h5' sx={{color:'black',mt:2,mb:4,direction:'rtl'}}>مدل: {i.title2} </Typography>)}
          <Box  sx={{width:'100%',direction:{xs:'rtl',md:'ltr'}, display:'flex',flexDirection:{xs:"column",md:"row"},justifyContent:'center',bgcolor:'#fff'}}>
