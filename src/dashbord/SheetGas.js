...
برای انتخاب اجاق گاز دلخواهتون فقط کافیه یه سر به سرزمین پرحرارت اجاق‌گازها اسنوا بزنین.
       ...
       color:'white'}, fontSize:"18px",color:'#eeeeee',m:3,backgroundImage:"linear-gradient(to right ,#E0AA3E,#282828)"}}>  <NavLink className='link' to={"/allgas" }>  مشاهده همه ی اجاق گازها </NavLink></Button>
        </Grid>
        </Grid>
